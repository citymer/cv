  ...
  return (
    <div className="contentText">
      ...
      <ul>
        ...
        <div className="contentImg">
          <img src={petitsplats} alt="projet 2" />
          <div className="contentLogo">
            <a
              target="_blank"
              rel="noreferrer"
        ...
        <div className="contentImg">
          <img src={argentbank} alt="projet 11" />
          <div className="contentLogo">
            <a
              target="_blank"
              rel="noreferrer"
